...
model = dict(
    ...
    det_model_ckpt='/home/ubuntu/21chi.nh/Quantization/SAM_Quantization/SAM_Quantization/ckts/r50_hybrid_branch_lambda1_group6_t1500_dp0_mqs_lft_deformable_detr_plus_iterative_bbox_refinement_plus_plus_two_stage_36eps.pth',
    num_classes=80,
    model_type='vit_b',
